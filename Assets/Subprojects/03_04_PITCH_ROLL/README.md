# Subprojects 03–04 — Pitch and Roll

## Goal
Archive the combined pitch-and-roll milestone as one paired Unity and Arduino subproject.

## Pairing
- Unity scene: `Scenes/SP03_04_PitchRoll.unity`
- Unity script: `Scripts/SP03_04_PitchRoll.cs`
- Arduino sketch: `Arduino/03_04_UNITY_PITCH_ROLL/03_04_UNITY_PITCH_ROLL.ino`
...
Directly builds on Subproject 02's rotation-to-servo path. Subprojects 03 and 04 are grouped because pitch and roll were developed as one combined milestone.
