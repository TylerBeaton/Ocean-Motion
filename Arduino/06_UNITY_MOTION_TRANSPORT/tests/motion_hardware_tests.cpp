...
int main()
{
    ...
    assert(MotionHardware::pitchTarget(-35.0f).pulse == 271u);
    assert(MotionHardware::pitchTarget(35.0f).pulse == 343u);
    assert(MotionHardware::pitchTarget(-100.0f).pulse == 235u);
